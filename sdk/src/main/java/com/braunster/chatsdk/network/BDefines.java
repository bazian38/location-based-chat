...
public class BDefines {
    ...
    public static String BRootPath = "test_chat/";

    public static void changeRootForTesting() {
        BRootPath = "unit_tests/";
    }
    ...
    public static String ServerUrl = "https://chat-location-fb8a1.firebaseio.com/" + BRootPath;

    /** The url that is used for the file uploads.*/
    public static String FirebaseStoragePath = "gs://chat-location-fb8a1.appspot.com";
